                        ...
                        <div class="card mb-0">
                            ...
                            <div class="card-body">
                                <a href="{{ route('login') }}" class="brand-logo">
                                    ...
                                    @else
                                        <h2 class="brand-text text-primary ms-1">Tenant Panel</h2>
                                    @endif
                                </a>
                                <h4 class="card-title mb-1">Login to your account!</h4>
                                <!-- <p class="card-text mb-2">Please login to your account.</p> -->

                                <form class="auth-login-form mt-2" action="{{ route('store.login') }}" method="POST">
                                    @csrf
                                    <div class="mb-1">
                                ...
                                @if(request()->getHost() == '127.0.0.1' || request()->getHost() == 'localhost')
                                    <p class="text-center mt-2">
                                        <span>Want to register as Company?</span>
