                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="{{ route('login') }}" class="brand-logo">
                                    <h2 class="brand-text text-primary ms-1">Multi Tenant System</h2>
                                </a>

                                <h4 class="card-title mb-1">Register to create new tenant! </h4>
                                <!-- <p class="card-text mb-2">Create new tenant!</p> -->

                               <form class="auth-register-form mt-2" action="{{ route('company.store.register') }}" method="POST">
                                    @csrf
